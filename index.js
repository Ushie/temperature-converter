document.getElementById("submitButton").onclick = function () {
    ...
    var converter = {
        celsius: { toKelvin: temp => temp + 273.15, fromKelvin: temp => temp - 273.15 },
        fahrenheit: { toKelvin: temp => (temp - 32) * 5 / 9 + 273.15, fromKelvin: temp => (temp - 273.15) * 9 / 5 + 32 },
        rankine: { toKelvin: temp => temp * 5 / 9, fromKelvin: temp => temp * 1.8 },
        romer: { toKelvin: temp => (temp - 7.5) / 0.52500 + 273.15, fromKelvin: temp => (temp - 273.15) * 21 / 40 + 7.5 },
